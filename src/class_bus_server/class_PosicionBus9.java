...
public class class_PosicionBus9 extends Observable implements Runnable {
...
//posicion inicial bus
    ...
    public class_PosicionBus9(class_monitor m) {
    ...
    public void run() {
        ...
        try {
            ...
            while (iterar) {
                ...
                //notifica observadores posicion bus
                setChanged();
                notifyObservers(posicion);
                this.clearChanged();
               monitor.bus9(posicion);
                ...
                if (monitor.compara_b9_b8() == true) {
                    Thread.sleep(0);
                    //notifica concurrencia y no hay espera
                    setChanged();
                    notifyObservers("Concurrencia Bus 9 y Bus 8 \n");
                    this.clearChanged();
